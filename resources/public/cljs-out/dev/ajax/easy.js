...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__11885 = cljs.core.second(format);
var G__11886 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__11885,G__11886) : ajax.easy.keyword_response_format_element.call(null,G__11885,G__11886));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11889_SHARP_){
return ajax.easy.keyword_response_format_element(p1__11889_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__11890){
var map__11891 = p__11890;
var map__11891__$1 = ((((!((map__11891 == null)))?(((((map__11891.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11891.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11891):map__11891);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11891__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11891__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11891__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__11891,map__11891__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__11893){
var vec__11894 = p__11893;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11894,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11894,(1),null);
var fexpr__11897_11898 = (cljs.core.truth_(ok)?h:e);
(fexpr__11897_11898.cljs$core$IFn$_invoke$arity$1 ? fexpr__11897_11898.cljs$core$IFn$_invoke$arity$1(result) : fexpr__11897_11898.call(null,result));
...
;})(h,e,map__11891,map__11891__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__11899){
...
var opts = map__11900__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11900__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11900__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11900__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11900__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11900__$1,cljs.core.cst$kw$body);
