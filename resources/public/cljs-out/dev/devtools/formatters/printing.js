...
var len__4531__auto___27117 = arguments.length;
var i__4532__auto___27118 = (0);
while(true){
if((i__4532__auto___27118 < len__4531__auto___27117)){
args__4534__auto__.push((arguments[i__4532__auto___27118]));

var G__27119 = (i__4532__auto___27118 + (1));
i__4532__auto___27118 = G__27119;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27114){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27115,G__27116,seq27114__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27120_SHARP_){
return !((cljs.core.meta.call(null,p1__27120_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__27121__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27125){var _e__26325__auto__ = e27125;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e27127){var _e__26325__auto__ = e27127;
return false;
}}
})())){
...
var _STAR_current_state_STAR_27129 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__27130 = opts;
...
var markup_db = cljs.core.get.call(null,map__27130__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_27129;
}});
...
;
var temp__5455__auto___27134 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___27134)){
var managed_print_level_27135 = temp__5455__auto___27134;
var _STAR_print_level_STAR_27133_27136 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_27135;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_27133_27136,managed_print_level_27135,temp__5455__auto___27134,writer,opts,job_fn){
return (function (p1__27132_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__27132_SHARP_,null);
});})(_STAR_print_level_STAR_27133_27136,managed_print_level_27135,temp__5455__auto___27134,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_27133_27136;
}} else {
job_fn.call(null);
}
