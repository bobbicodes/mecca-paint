...
var G__21458 = devtools.prefs.pref.call(null,v);
v = G__21458;
continue;
} else {
return v;
...
}catch (e21461){var _e__20712__auto__ = e21461;
return false;
}})();
...
}catch (e21465){var _e__20712__auto__ = e21465;
return false;
}})();
...
}catch (e21467){var _e__20712__auto__ = e21467;
return false;
}}
}
});
...
var vec__21469 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21469,(0),null);
var name = cljs.core.nth.call(null,vec__21469,(1),null);
...
return cljs.core.some.call(null,(function (p1__21472_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21472_SHARP_);
}),template);
});
