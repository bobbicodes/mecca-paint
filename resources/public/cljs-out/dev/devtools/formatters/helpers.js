...
var G__27107 = devtools.prefs.pref.call(null,v);
v = G__27107;
continue;
} else {
return v;
...
}catch (e27110){var _e__26361__auto__ = e27110;
return false;
}})();
...
}catch (e27114){var _e__26361__auto__ = e27114;
return false;
}})();
...
}catch (e27116){var _e__26361__auto__ = e27116;
return false;
}}
}
});
...
var vec__27118 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27118,(0),null);
...
return cljs.core.some.call(null,(function (p1__27121_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27121_SHARP_);
}),template);
});
