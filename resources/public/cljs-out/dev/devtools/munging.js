...
var o26534 = temp__5455__auto__;
var temp__5455__auto____$1 = (o26534["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o26535 = temp__5455__auto____$1;
return (o26535["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26354__auto__ = f;
return (o__26354__auto__["toString"]).call(o__26354__auto__);
} else {
return "";
}
}catch (e26536){var _ = e26536;
return "";
}});
...
try{var o__26354__auto___26538 = t;
(o__26354__auto___26538["cljs$lang$ctorPrWriter"]).call(o__26354__auto___26538,t,writer);
}catch (e26537){var __26539 = e26537;
}
...
var char_code = (function (){var o__26354__auto__ = (new String(char$));
return (o__26354__auto__["charCodeAt"]).call(o__26354__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26354__auto__ = String;
return (o__26354__auto__["fromCharCode"]).call(o__26354__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26540 = num_code;
switch (G__26540) {
case (1):
return (185);
...
var o__26354__auto__ = String;
return (o__26354__auto__["fromCharCode"]).call(o__26354__auto__,superscript_code);
});
/**
...
}catch (e26542){var _e__26361__auto__ = e26542;
return false;
}})())){
...
var vec__26543 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__26543,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o26546 = temp__5455__auto__;
var temp__5455__auto____$1 = (o26546["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o26547 = temp__5455__auto____$1;
return (o26547["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26550){
var vec__26551 = p__26550;
var ns_detector = cljs.core.nth.call(null,vec__26551,(0),null);
...
var G__26557 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__26558 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__26557;
remaining_tokens = G__26558;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26548){
var G__26549 = cljs.core.first.call(null,seq26548);
var seq26548__$1 = cljs.core.next.call(null,seq26548);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26549,seq26548__$1);
});
...
var vec__26562 = cljs.core.split_with.call(null,(function (p1__26561_SHARP_){
return cljs.core.not_EQ_.call(null,p1__26561_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__26562,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__26562,(1),null);
...
var vec__26565 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__26565,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__26565,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__26568 = cljs.core.rest.call(null,remaining_tokens);
var G__26569 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__26568;
name_tokens = G__26569;
continue;
} else {
...
var vec__26572 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__26572,(0),null);
var arity = cljs.core.nth.call(null,vec__26572,(1),null);
var vec__26575 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__26575,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__26575,(1),null);
var vec__26578 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__26578,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__26578,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__26578,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__26578,(3),null);
...
var vec__26584 = result;
var munged_ns = cljs.core.nth.call(null,vec__26584,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__26584,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__26584,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__26584,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__26584,(4),null);
var arity = cljs.core.nth.call(null,vec__26584,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__26588 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__26588,(0),null);
var args = cljs.core.nth.call(null,vec__26588,(1),null);
var vec__26591 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__26591,(0),null);
var name = cljs.core.nth.call(null,vec__26591,(1),null);
...
var G__26594 = (arity + (1));
var G__26595 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__26596){
var vec__26597 = p__26596;
var arity = cljs.core.nth.call(null,vec__26597,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__26597,(1),null);
...
return cljs.core.get.call(null,arities,p1__26600_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__26601_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__26604){
var vec__26605 = p__26604;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__26605,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq26602){
var G__26603 = cljs.core.first.call(null,seq26602);
var seq26602__$1 = cljs.core.next.call(null,seq26602);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26603,seq26602__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__26613__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__26613__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__26613__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__26613__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__26614 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__26614,(0),null);
var fn_name = cljs.core.nth.call(null,vec__26614,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__26614,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__26614,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__26614,(4),null);
var arity = cljs.core.nth.call(null,vec__26614,(5),null);
...
var o__26354__auto__ = f;
return (o__26354__auto__["getBasis"]).call(o__26354__auto__);
});
/**
...
}catch (e26618){var _e__26361__auto__ = e26618;
...
var G__26619 = (obj[cljs.core.first.call(null,path)]);
var G__26620 = cljs.core.rest.call(null,path);
obj = G__26619;
path = G__26620;
continue;
} else {
...
return (function (accum,p__26621){
var vec__26622 = p__26621;
var bit = cljs.core.nth.call(null,vec__26622,(0),null);
var protocol = cljs.core.nth.call(null,vec__26622,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__26625){
var vec__26626 = p__26625;
var ns = cljs.core.nth.call(null,vec__26626,(0),null);
var name = cljs.core.nth.call(null,vec__26626,(1),null);
var selector = cljs.core.nth.call(null,vec__26626,(2),null);
...
return (function (p__26630){
var vec__26631 = p__26630;
var munged_name = cljs.core.nth.call(null,vec__26631,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__26631,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__26631,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__26629_SHARP_){
return (obj[cljs.core.first.call(null,p1__26629_SHARP_)]);
});})(name,sorted_matches,vec__26631,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
