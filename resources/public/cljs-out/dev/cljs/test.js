...
var G__20239 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__20239,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__20239;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq20241){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20242,G__20243,seq20241__$2);
});
...
var file = cljs.core.get.call(null,map__20248__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__20248__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__20248__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__20248,map__20248__$1,file,line,column){
return (function (p1__20247_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__20247_SHARP_));
});})(map__20248,map__20248__$1,file,line,column))
...
var temp__5457__auto___20250 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20250)){
var message_20251 = temp__5457__auto___20250;
cljs.core.println.call(null,message_20251);
} else {
}
...
var temp__5457__auto___20252 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20252)){
var message_20253 = temp__5457__auto___20252;
cljs.core.println.call(null,message_20253);
} else {
}
...
var output_dir__$1 = (function (){var G__20254 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20254),"/"].join('');
} else {
return G__20254;
}
})();
...
var G__20256 = exception.stack;
var G__20256__$1 = (((G__20256 == null))?null:clojure.string.split_lines.call(null,G__20256));
var G__20256__$2 = (((G__20256__$1 == null))?null:cljs.core.get.call(null,G__20256__$1,depth));
if((G__20256__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__20256__$2);
}
} else {
...
var vec__20257 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__20257,(0),null);
var column = cljs.core.nth.call(null,vec__20257,(1),null);
var vec__20260 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__20260,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__20260,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__20260,(2),null);
...
var m__$1 = (function (){var G__20263 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__20267 = (function (){var G__20266 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__20266);
} else {
return G__20266;
}
})();
...
return cljs.core.vary_meta.call(null,G__20268,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__20270 = e;
var G__20270__$1 = (((G__20270 instanceof cljs.core.Keyword))?G__20270.fqn:null);
switch (G__20270__$1) {
...
var vec__20272 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__20272,(0),null);
var types = vec__20272;
...
return cljs.core.map.call(null,(function (p__20275){
var vec__20276 = p__20275;
var ns = cljs.core.nth.call(null,vec__20276,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__20276,(1),null);
return ((function (vec__20276,ns,vars__$1){
return (function (){
...
var G__20279 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__20279,G__20279__$1,env,once_fixtures,each_fixtures,vec__20276,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__20279,G__20279__$1,env,once_fixtures,each_fixtures,vec__20276,ns,vars__$1){
return (function (){
var seq__20280 = cljs.core.seq.call(null,vars__$1);
var chunk__20281 = null;
var count__20282 = (0);
var i__20283 = (0);
while(true){
if((i__20283 < count__20282)){
var v = cljs.core._nth.call(null,chunk__20281,i__20283);
var temp__5457__auto___20285 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20285)){
var t_20286 = temp__5457__auto___20285;
each_fixture_fn.call(null,((function (seq__20280,chunk__20281,count__20282,i__20283,t_20286,temp__5457__auto___20285,v,each_fixture_fn,G__20279,G__20279__$1,env,once_fixtures,each_fixtures,vec__20276,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20286)));
});})(seq__20280,chunk__20281,count__20282,i__20283,t_20286,temp__5457__auto___20285,v,each_fixture_fn,G__20279,G__20279__$1,env,once_fixtures,each_fixtures,vec__20276,ns,vars__$1))
);
} else {
}


var G__20287 = seq__20280;
var G__20288 = chunk__20281;
var G__20289 = count__20282;
var G__20290 = (i__20283 + (1));
seq__20280 = G__20287;
chunk__20281 = G__20288;
count__20282 = G__20289;
i__20283 = G__20290;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__20280);
if(temp__5457__auto__){
var seq__20280__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__20280__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__20280__$1);
var G__20291 = cljs.core.chunk_rest.call(null,seq__20280__$1);
var G__20292 = c__4351__auto__;
var G__20293 = cljs.core.count.call(null,c__4351__auto__);
var G__20294 = (0);
seq__20280 = G__20291;
chunk__20281 = G__20292;
count__20282 = G__20293;
i__20283 = G__20294;
continue;
} else {
var v = cljs.core.first.call(null,seq__20280__$1);
var temp__5457__auto___20295__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20295__$1)){
var t_20296 = temp__5457__auto___20295__$1;
each_fixture_fn.call(null,((function (seq__20280,chunk__20281,count__20282,i__20283,t_20296,temp__5457__auto___20295__$1,v,seq__20280__$1,temp__5457__auto__,each_fixture_fn,G__20279,G__20279__$1,env,once_fixtures,each_fixtures,vec__20276,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20296)));
});})(seq__20280,chunk__20281,count__20282,i__20283,t_20296,temp__5457__auto___20295__$1,v,seq__20280__$1,temp__5457__auto__,each_fixture_fn,G__20279,G__20279__$1,env,once_fixtures,each_fixtures,vec__20276,ns,vars__$1))
);
} else {
}


var G__20297 = cljs.core.next.call(null,seq__20280__$1);
var G__20298 = null;
var G__20299 = (0);
var G__20300 = (0);
seq__20280 = G__20297;
chunk__20281 = G__20298;
count__20282 = G__20299;
i__20283 = G__20300;
continue;
}
} else {
...
});})(each_fixture_fn,G__20279,G__20279__$1,env,once_fixtures,each_fixtures,vec__20276,ns,vars__$1))
);
});})(each_fixture_fn,G__20279,G__20279__$1,env,once_fixtures,each_fixtures,vec__20276,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20279__$1)].join('')));

}
})());
});
;})(vec__20276,ns,vars__$1))
