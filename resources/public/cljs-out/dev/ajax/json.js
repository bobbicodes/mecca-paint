...
var ajax$json$make_json_response_format_$_json_response_format__1 = (function (p__11804){
...
var prefix = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11805__$1,cljs.core.cst$kw$prefix);
var keywords_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11805__$1,cljs.core.cst$kw$keywords_QMARK_);
var raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11805__$1,cljs.core.cst$kw$raw);
return ajax.interceptors.map__GT_ResponseFormat(new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$read,((function (map__11805,map__11805__$1,prefix,keywords_QMARK_,raw){
return (function ajax$json$make_json_response_format_$_json_response_format_$_json_read_response_format(xhrio){
var G__11807 = raw;
var G__11808 = keywords_QMARK_;
var G__11809 = ajax.json.strip_prefix(prefix,ajax.protocols._body(xhrio));
return (read_json.cljs$core$IFn$_invoke$arity$3 ? read_json.cljs$core$IFn$_invoke$arity$3(G__11807,G__11808,G__11809) : read_json.call(null,G__11807,G__11808,G__11809));
});})(map__11805,map__11805__$1,prefix,keywords_QMARK_,raw))
...
ajax$json$make_json_response_format_$_json_response_format = function(p__11804){
switch(arguments.length){
case 0:
return ajax$json$make_json_response_format_$_json_response_format__0.call(this);
case 1:
return ajax$json$make_json_response_format_$_json_response_format__1.call(this,p__11804);
}
