...
var G__27071 = devtools.prefs.pref.call(null,v);
v = G__27071;
continue;
} else {
return v;
...
}catch (e27074){var _e__26325__auto__ = e27074;
return false;
}})();
...
}catch (e27078){var _e__26325__auto__ = e27078;
return false;
}})();
...
}catch (e27080){var _e__26325__auto__ = e27080;
return false;
}}
}
});
...
var vec__27082 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27082,(0),null);
var name = cljs.core.nth.call(null,vec__27082,(1),null);
...
return cljs.core.some.call(null,(function (p1__27085_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27085_SHARP_);
}),template);
});
