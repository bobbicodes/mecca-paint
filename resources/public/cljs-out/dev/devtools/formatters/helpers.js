...
var G__27096 = devtools.prefs.pref.call(null,v);
v = G__27096;
continue;
} else {
return v;
...
}catch (e27099){var _e__26350__auto__ = e27099;
return false;
}})();
...
}catch (e27103){var _e__26350__auto__ = e27103;
return false;
}})();
...
}catch (e27105){var _e__26350__auto__ = e27105;
return false;
}}
}
});
...
var vec__27107 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27107,(0),null);
var name = cljs.core.nth.call(null,vec__27107,(1),null);
...
return cljs.core.some.call(null,(function (p1__27110_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27110_SHARP_);
}),template);
});
