...
var G__27090 = devtools.prefs.pref.call(null,v);
v = G__27090;
continue;
} else {
return v;
...
}catch (e27093){var _e__26344__auto__ = e27093;
return false;
}})();
...
}catch (e27097){var _e__26344__auto__ = e27097;
return false;
}})();
...
}catch (e27099){var _e__26344__auto__ = e27099;
return false;
}}
}
});
...
var vec__27101 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27101,(0),null);
var name = cljs.core.nth.call(null,vec__27101,(1),null);
...
return cljs.core.some.call(null,(function (p1__27104_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27104_SHARP_);
}),template);
});
